...
# Actions
1. Select `Sell`. [Valid: standard marginal FX or CFD instrument]
...
6. Compare the recorded `Order Price` to the expected default price (B - default_distance), stepped to the `price_increment` grid.
...
- The `Order Price` value is unchanged from the numeric value recorded in step 4 following step 5.
